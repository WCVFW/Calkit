  ...
  return (
    <div className="fixed top-6 right-6 z-50 space-y-3 max-w-sm">
      {notifications.map((notification) => (
        ...
        >
          {notification.type === 'success' && <CheckCircleIcon className="w-5 h-5 flex-shrink-0" />}
          {notification.type === 'warning' && <ExclamationTriangleIcon className="w-5 h-5 flex-shrink-0" />}
          {notification.type === 'error' && <ExclamationTriangleIcon className="w-5 h-5 flex-shrink-0" />}
