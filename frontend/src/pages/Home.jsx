            ...
            {[
              ...
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mb-4 overflow-hidden flex items-center justify-center">
                  <img src={item.imgSrc} alt={item.label} className="w-full h-full object-contain" />
                </div>
      ...
      <section className="bg-[#036] mx-3 sm:mx-6 md:mx-12 lg:mx-32 p-6 md:p-10 lg:p-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            {[
              {
                ...
                items: ["Private Limited Company Registration", "Limited Liability Partnership Registration", "One Person Company Registration", "Sole Proprietorship Registration", "Producer Company Registration", "Partnership Firm Registration", "Startup India Registration", "NGO Registration"],
              },
              {
                title: "Operate with Clarity",
                items: ["GST Registration", "Change Company Address", "Director Replacement", "Mandatory Annual Filings", "Labor Compliance", "Shop and Establishment License", "Accounting & Tax"],
              },
              {
                title: "Secure a Legacy",
                items: ["Trademark Registration", "Copyright Registration", "Patent Registration", "IP Infringement", "Design Registration", "Free Legal Document", "Business Contracts"],
              },
            ].map((section, idx) => (
              <div key={idx} className="mb-12 relative">
                ...
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 relative z-10">
                  <div className="relative flex flex-col items-center">
                    <svg className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" viewBox="0 0 72 72" aria-hidden="true">
          ...
          <div className="flex flex-col items-center justify-around gap-6 sm:gap-8">
            {[
              { src: "https://api.builder.io/api/v1/image/assets/TEMP/959feee3eee9528bc346a7c66dda752400b02f3a?width=538", size: "w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56", animate: { y: [0, -25, 0], x: [0, 25, 0] } },
              { src: "https://api.builder.io/api/v1/image/assets/TEMP/3d32e547220713bb25d24504a9b2385dabdc0361?width=414", size: "w-36 h-36 sm:w-44 sm:h-44 md:w-52 md:h-52", animate: { y: [0, 25, 0], x: [0, -25, 0] } },
        ...
        <div className="relative max-w-7xl mx-auto flex flex-col items-center bg-[url('https://storage.googleapis.com/tagjs-prod.appspot.com/v1/wubvUxErdY/s3genjtx_expires_30_days.png')] bg-cover bg-center pt-28 sm:pt-32 pb-24 sm:pb-28 px-6 sm:px-12 gap-12">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center w-full relative">
            <div className="flex flex-col items-center bg-white/70 backdrop-blur-md rounded-2xl px-4 py-2 shadow-md lg:absolute lg:left-6 lg:top-1/2 lg:-translate-y-1/2 mb-4 lg:mb-0">
              <span className="text-gray-900 font-bold text-sm sm:text-base">Automated Compliance</span>
            </div>
            ...
            <div className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full bg-gray-300 flex items-center justify-center shadow-lg mx-2">
              <svg className="w-40 h-40 sm:w-48 sm:h-48" viewBox="0 0 352 352" aria-hidden="true">
            ...
            <div className="flex flex-col items-center bg-white/70 backdrop-blur-md rounded-2xl px-4 py-2 shadow-md lg:absolute lg:right-6 lg:top-1/2 lg:-translate-y-1/2 mt-4 lg:mt-0">
              <span className="text-gray-900 font-bold text-sm sm:text-base">Secure Documents Vault</span>
            </div>
          </div>

          <div className="flex flex-col items-center bg-white/70 backdrop-blur-md rounded-2xl px-4 py-2 shadow-md mt-4 sm:mt-6">
            <span className="text-gray-900 font-bold text-sm sm:text-base">Expert Connect</span>
          </div>
        </div>
      </section>
