  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 rounded shadow">
      ...
      <form onSubmit={sendOtp}>
        ...
        <input value={mobile} onChange={(e)=>setMobile(e.target.value)} className="mt-2 w-full border px-3 py-2 rounded" placeholder="e.g. +911234567890" />
        <button disabled={loading} className="mt-4 w-full bg-[#003366] text-white py-2 rounded">{loading ? 'Sending...' : 'Send OTP'}</button>
      </form>
